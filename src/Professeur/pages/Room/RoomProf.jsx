                ...
                <div className=" gap-1 w-full lg:w-8/12 h-full">
                    <div className="grid grid-cols-2 gap-1 w-full mb-2">
                        ...
                        <div className=" ">
                            ...
                            <div className="relative my-1 h-2/6 w-full gap-1 grid grid-cols-2">
                                <div><CardEtu /></div>
                                <div><CardEtu /></div>
                            </div>
                    ...
                    <div className=" h-2/6 w-full">
                        <div className='flex h-full'>
                            <div className='w-1/4 h-full'><AddFolder/></div>
                            <div className='w-3/4 h-full'><ListFolderProf /></div>
                        </div>
                    </div>
                </div>
                <div className={`absolute top-0 lg:fixed lg:w-4/12 lg:right-0 lg:translate-x-0 h-full transition-all duration-500 ${isMessagePanelOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                    <MessageProf />
                </div>
            </div>
        </section>
