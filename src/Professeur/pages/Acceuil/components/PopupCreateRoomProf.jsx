            ...
            <div>
                ...
                <form action="">
                    <div className="w-full bg-white mb-10 border rounded-md">
                        <input type="text" placeholder="Cours" className="px-5 py-4 w-full outline-none" />
                    </div>
                    
                    <div className="w-full bg-white mb-10 border rounded-md">
                        <input type="text" placeholder="Mot de passe du room" className="px-5 py-4 w-full outline-none" />
                    </div>
